      ...
      <div className="bg-darkgreen rounded-md w-1/2">
        ...
        {type === "public transit" && (
          <FootprintRetire
            ...
            retireTokens={retireTokens}
          />
        )}

        {type === "flight" && (
          <FootprintRetire title="flight" typesName="Flight" balance={balance}
          tokenAmount={tokenAmount}
          setTokenAmount={setTokenAmount}
          retireTokens={retireTokens}/>
        )}

        {type === "car" && <FootprintRetire title="car ride" typesName="Car" balance={balance}
            tokenAmount={tokenAmount}
            setTokenAmount={setTokenAmount}
            retireTokens={retireTokens}/>}
        <div></div>
