...
const company = () => {
  ...
  const sendData = async () => {
    ...
    const companyFactory = new ethers.Contract(
      contractAddress,
      contractABI,
      signer
    );
    ...
    let address = "";
    companyFactory
      .on("NewCompaniesCreated", (companyAddress) => {
        ...
        <div className="flex justify-center bg-darkgreen w-[40%] rounded-lg py-4">
          <div className="flex flex-col ">
            ...
            <div className="py-4 flex flex-col">
              ...
              <input
                className="w-72 h-8 rounded-lg px-4 focus:outline-none"
            ...
            <div className="py-4 flex flex-col">
              <label className=" text-white py-1">
                Carbon Credits Emitted:
              </label>
              <input
                type="number"
                className="w-72 h-8 rounded-lg px-4 focus:outline-none"
                onChange={(e) => setCarbonEmitted(e.target.value)}
                value={carbonEmitted}
              ></input>
            </div>
            <div className="py-4 flex flex-col">
