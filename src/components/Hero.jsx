...
export default function Hero() {
    return (
        <div className="px-12 flex min-h-full gap-10 pb-10">
            <div>
                ...
                <p className="w-[30em]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse sed facilisis diam. Praesent tincidunt lobortis turpis. In vehicula posuere iaculis. Nunc a metus eu turpis ultrices tincidunt sed sed metus.</p>
            </div>
            <div className="pt-7">
            ...
            <img className="absolute z-10 right-4 -bottom-32" src={photos}></img>
        </div>
    )
}