...
const Hero = () => {
	return (
		<div id="hero" className="flex justify-around my-16 mx-10">
			<div className="flex flex-col justify-center w-[40%]">
				...
				<button
					type="button"
					className="mt-4 hover:bg-white px-4 py-2 rounded-full border-[1px] border-grey transition duration-300 ease-in-out w-44 font-semibold text-white bg-darkgreen hover:text-grey text-md"
				>
					Learn More
				</button>
			</div>
